...
<div class="d-grid gap-2 d-md-flex justify-content-md-end p-3">
  <button type="button" class="btn btn-outline-primary" style="background: #dc3545; border: #dc3545; font-weight: 400;" data-bs-toggle="modal" data-bs-target="#cancelModal">Cancel</button>
