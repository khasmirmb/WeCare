    ...
    ?>
        ...
        <td class="text-center">
                <div class="btn-group" role="group">
                    ...
                    <a type="button" id="delete-med" class="patient-delete mx-2 d-flex justify-content-center text-white text-decoration-none" href="../staff/delete-medicine.php?id=<?php echo $med['id'] ?>&patient_id=<?php echo $patient->id ?>"><i class="fa-solid fa-trash"></i>Delete</a>
                </div>
        </td>
        </tr>
    <?php } ?>
