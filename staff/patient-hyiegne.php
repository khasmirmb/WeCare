...
<div class="table-responsive">
  ...
  <tbody>
    ...
    ?>
        ...
        <td class="text-center">
                <div class="btn-group" role="group">
                    ...
                    <a type="button" id="delete-hy" class="patient-delete mx-2 d-flex justify-content-center text-white text-decoration-none" href="../staff/delete-hyiegne.php?id=<?php echo $hy['id'] ?>&patient_id=<?php echo $patient->id ?>"><i class="fa-solid fa-trash"></i>Delete</a>
                </div>
        </td>
        </tr>
    <?php } ?>
    ...
    <div class="d-grid gap-2 pt-3">
        <button class="btn btn-primary" type="button" style="background: #00ACB2; border: none;" data-bs-toggle="modal" data-bs-target="#hy-modal"><i class="fa-solid fa-circle-plus"></i>Add more</button>
    </div>
</div>
</div>
</div><!--Last of Hyiegne-->
