...
<head>
    ...
    <title>Admission | WeCare Nursing Home, Inc.</title>
                ...
                <div class="details personal">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="date" placeholder="Enter birth date" class="date picker" required>
                        </div>
                ...
                <div class="details ID">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="date" placeholder="Enter your issued date" class="date picker" required>
                        </div>

                        <div class="input-field">
                            <label>Expiry Date</label>
                            <input type="date" placeholder="Enter expiry date" class="date picker" required>
                        </div>
                    </div>
