<?php
    ...
    $page_title = 'WeCare - Patient Details';
  ...
  <div class="container form-control">
    ...
    <h2 class="mb-4"><strong>Patient's Personal Details</strong></h2>
      <form class="row needs-validation">
        <div class="row">
          <div class="mb-3">
            <label for="formFile" class="form-label"><strong>Patient Image</strong></label>
        ...
        <div class="d-flex py-3 justify-content-end">
          <a href="survey.php" class="btn btn-outline-primary me-1" role="button" aria-pressed="true">Back</a>

          <button class="btn btn-primary" type="button"><a class="text-white text-decoration-none" href="relative-info.php">Next</a></button>
        </div>
      </form>
    </div>
  </div>
