...
<div class="container-first-nav">
  ...
  <div class="container-fluid">
    ...
    <img src="../images/logo.png" alt="" width="30" height="24">WeCare
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
          <a class="nav-link" href="../history/timeline.php">History</a>
        </li>
        <li class="nav-item">
        ...
        <button class="btn btn-outline-success" href="#">REGISTER</button>
    </div>
  </div>
</nav>
</header>