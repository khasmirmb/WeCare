...
<div class="card text-center">
  ...
  <div class="col-5 col-lg-2"><!--Start of Users title-->
    ...
    <button class="btn btn-primary" type="button" style="background: #00ACB2; border: #00ACB2;"><a class="text-white text-decoration-none" href="../admin/add-user.php">Add User</a></button>
    </div><!--end of add user-->
