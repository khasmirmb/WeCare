...
<div class="card text-center">
  ...
  <div class="col-5 col-lg-2"><!--Start of Users title-->
    ...
    <button class="btn btn-primary" type="button"><a class="text-white text-decoration-none" href="add-user.php">Add User</a></button>
    </div><!--end of add user-->
    ...
    <thead class="table-info ">
        ...
        <th scope="col" class="text-center">Remind</th>
        </tr>
    </thead>
    <tbody>
        <tr>
        ...
        <td class="text-center"></td><!--Remind Icon-->
       </tr>
        <tr>
        <td><a href="#" class="text-decoration-none text-dark text-left">James869</a></td>
        <td class="text-left">James Brown</td>
