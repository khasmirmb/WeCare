...
<div class="container align-items-center pt-3">
    <button class="btn btn-primary" type="button"><a class="text-white text-decoration-none" href="visitor-log.php"> < Visitor </a></button>
  ...
  <button class="btn btn-primary" type="button">Add Visitor</button> <!--Should have modal-->
</div><!--End of buttons-->
