...
<button type="button" class="btn btn-primary" style="background: #00ACB2; border: #00ACB2;"><a class="text-white text-decoration-none" href="../admin/patient-details.php"> <i class="fa-solid fa-arrow-left"></i> Back</a></button>
