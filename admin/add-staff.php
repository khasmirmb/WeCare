...
<div class="container align-items-center pt-3">
    <button class="btn btn-primary" type="button"><a class="text-white text-decoration-none" href="staff-account.php"> < Staff </a></button>
  ...
  <button class="btn btn-primary" type="button">Add Staff</button> <!--Should have modal-->
</div><!--End of buttons-->
