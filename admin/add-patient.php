...
<form action="add-patient.php" method="POST" class="form pt-3 mb-5" enctype="multipart/form-data">
    ...
    <button type="button" class="btn btn-danger">Cancel</button><!--Should put a modal-->
    <button class="btn btn-secondary" style="background: #00ACB2; border: #00ACB2; color: #fff;" name= "submit">Save</button> <!--Should put a modal-->
    </div>
    </div><!--Buttons-->
</form>
