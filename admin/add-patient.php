...
<div class="container align-items-center pt-3">
    ...
    <div class="pt-4">
    <h2 class="mb-4"><strong>Add Patient</strong></h2>
  ...
  <div class="row"><!--Second row-->
    ...
    <div class="pt-4">
    <h2 class="mb-4"><strong>Nurse Assign</strong></h2>
    <div class="container form-control">
    <div class="container-fluid">

    <form style="margin-bottom: 20px;"><!--Starting of the form-->
  <div class="pt-3">

  <div class="row"><!--First row-->
   <div class="col-sm">
    <label for="gender"><strong>Nurses:</strong></label><br>
    <select name="gender" id="gender" class="form-control" style="width: 60%;">
  ...
  <button class="btn btn-danger me-md-2" type="button" data-bs-toggle="modal" data-bs-target="#deleteAccModal">Reset Data</button> <!--Should have modal-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="del-modal-body">
				<p>Do you really want to reset the data? This process cannot be undone.</p>
			</div>
