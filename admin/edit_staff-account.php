...
<div class="staff-account" style="padding-top: 1rem;">
		<div class="container">
			<h1 class="pb-3">Staff Account Profile</h1>
			<div class="bg-white shadow rounded-lg d-block d-sm-flex">
				...
				<div class="tab-content p-4 p-md-5" id="v-pills-tabContent">
					...
					<div class="tab-pane fade" id="security" role="tabpanel" aria-labelledby="security-tab">
						...
						<div>
							<button class="btn btn-primary" style="background: #dc3545; border: #dc3545;" data-bs-target="#deleteAccModal">Delete Account</button>
