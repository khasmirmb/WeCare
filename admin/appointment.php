...
<div class="card text-center">
  ...
  <div class="card-header"><!--Start of Card-->
    <ul class="nav nav-tabs card-header-tabs">
      ...
      <li class="nav-item">
        <a class="nav-link active" aria-current="true" href="appointment.php">Appointment</a>
      </li>
      <li class="nav-item">
  ...
  <table class="table table-hover table-sm">
    ...
    <tbody>
      <tr>
        ...
        <td class="pt-4"><a href="appointment-details.php" class="text-decoration-none text-dark text-left">Clinton Squidward</a></td>
        <td class="pt-4">
