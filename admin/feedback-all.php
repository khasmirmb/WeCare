...
<div class="container align-items-center pt-3">
    ...
    <button type="button" class="btn btn-outline-primary text-white"><a href="feedback-read.php" class="text-decoration-none">Read</a></button>
    </div>
    </div><!--End of button-->
