...
<button type="button" class="btn btn-primary" style="background: #00ACB2; border: #00ACB2;"><a class="text-white text-decoration-none" href="../admin/patient-list.php"><i class="fa-solid fa-arrow-left"></i> Back</a></button>
...
<div class="col-12 col-lg-12">
    <div class="text-wrap py-3 px-5 text-light rounded" style="background: #00ACB2; color: #fff;">
        ...
        <button type="button" class="btn btn-outline-light text-primary" style="background: #00ACB2; color:#fff; font-weight: bold;"><a class="text-decoration-none text-light" href="../admin/previous-nurse.php">Previous Nurse</a></button>
        </div>
